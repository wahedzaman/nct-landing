      ...
      <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-5 space-y-12">
            ...
            {/* Visual World Map Silhouette */}
            <div className="relative h-64 bg-slate-900 rounded-3xl border border-slate-800 overflow-hidden shadow-inner group">
              {/* Grid lines */}
              ...
              {/* Map Outline Simulation using SVG */}
              <svg className="absolute inset-0 w-full h-full text-slate-800" fill="currentColor" viewBox="0 0 1000 500" xmlns="http://www.w3.org/2000/svg">
                {/* Simplified aesthetic world map paths */}
                <path d="M150,150 Q180,100 230,120 T280,150 T310,200 T270,250 T200,280 T150,230 Z" opacity="0.6"/> {/* NA */}
                <path d="M220,300 Q260,330 250,380 T280,440 T290,480 T250,450 T220,350 Z" opacity="0.6"/> {/* SA */}
                <path d="M420,130 Q460,110 500,120 T550,150 T520,200 T460,220 T420,170 Z" opacity="0.6"/> {/* Europe */}
                <path d="M450,220 Q500,250 510,320 T540,380 T490,440 T440,360 T420,280 Z" opacity="0.6"/> {/* Africa */}
                <path d="M520,160 Q650,100 750,110 T850,150 T920,200 T880,300 T750,280 T600,240 Z" opacity="0.6"/> {/* Asia */}
                <path d="M780,350 Q830,360 880,390 T840,440 T760,420 T780,370 Z" opacity="0.6"/> {/* Aus */}
              </svg>

              {/* Glowing Dots for Offices */}
              {branches.map((b, i) => (
                <div key={i} className={`absolute ${b.dotClass} w-4.5 h-4.5`}>
                  <span className="absolute inline-flex h-full w-full rounded-full bg-primary opacity-75 animate-ping" />
                  <span className="relative inline-flex rounded-full h-4.5 w-4.5 bg-primary border-2 border-white shadow-md cursor-pointer" title={b.name} />
                </div>
              ))}

              <div className="absolute bottom-4 left-6 right-6 flex items-center justify-between text-white/50 text-[10px] font-black uppercase tracking-widest">
                <span>NTC GLOBAL PRESENCE</span>
                <span className="flex items-center gap-1"><span className="w-1.5 h-1.5 rounded-full bg-primary" /> Active Hubs</span>
              </div>
            </div>
