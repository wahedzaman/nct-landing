        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-20 items-center relative">
            ...
            <div className="hidden md:flex items-center gap-6">
              ...
              <a href="https://www.facebook.com/newcitytradebd" className="w-10 h-10 text-white rounded-full flex items-center justify-center hover:bg-[#004e82] bg-[#0D76BC] transition-colors">
